...
<div class="app-header">
    ...
    <div>
        <h1>ระบบตรวจสอบการปฏิบัติวิทิสาสมาธิ โครงการปฏิบัติวิทิสาสมาธิ ๔๙ ล้านนาที</h1>
...
# ── Footer ─────────────────────────────────────────────────────────────────
st.markdown("---")
st.caption("🙏 ระบบตรวจสอบการปฏิบัติวิทิสาสมาธิ โครงการปฏิบัติวิทิสาสมาธิ ๔๙ ล้านนาที · อัปโหลดไฟล์ใหม่เพื่อรีเฟรชข้อมูล")
